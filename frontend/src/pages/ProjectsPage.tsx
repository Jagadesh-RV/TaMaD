          ...
          {projects.map((project: any, index: number) => {
            ...
            return (
              ...
              >
                <Card
                  interactive={false}
                  className="overflow-hidden transition-all duration-300 shadow-xs border"
                  style={{
                    borderColor: isExpanded ? (project.color || 'var(--color-accent)') : 'var(--color-border)',
                ...
                >
                  <div className="cursor-pointer p-6 hover:bg-[color:var(--color-surface-hover)] transition-colors" onClick={() => toggleExpand(project._id)}>
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0 flex-1 pt-1">
                          ...
                          <p className="mt-1 text-xs text-[color:var(--color-foreground-secondary)] line-clamp-1">
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          className="flex h-8 w-8 items-center justify-center rounded-full transition-colors hover:bg-[color:var(--color-danger-light)] text-[color:var(--color-muted)] hover:text-[color:var(--color-danger)]"
                        ...
                        <div className="flex h-8 w-8 items-center justify-center rounded-full text-[color:var(--color-muted)] hover:bg-[color:var(--color-surface-active)] transition-colors">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="h-2 w-full overflow-hidden rounded-full bg-[color:var(--color-surface-active)]">
                        <motion.div
                          initial={{ width: 0 }}
                  ...
                  <AnimatePresence>
                    {isExpanded && (
                      <motion.div
                        ...
                        className="overflow-hidden bg-[color:var(--color-surface-hover)]"
                      >
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {project.members.map((memberId: string, i: number) => (
                                  ...
                                  >
                                    ...
                                    <div>
                                      <p className="text-[13px] font-semibold text-[color:var(--color-foreground)] truncate">{memberId}</p>
                                    </div>
                                  </div>
                                ))}
                              </div>
